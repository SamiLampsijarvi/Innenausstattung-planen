...
-- durable result, so it is closed as unknown and is never retried. Fresh
-- databases have no historical attempt and therefore skip this correction.
...
begin
  ...
  if pool_row.active_attempt is not null then
