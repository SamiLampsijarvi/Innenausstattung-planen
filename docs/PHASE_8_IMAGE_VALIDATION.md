...
6. Für genau einen Versuch den geprüften Preis und die kurze Freigabefrist hinterlegen. Nach dem Versuch externe KI wieder ausschalten, Ergebnis bewerten und Google-Abrechnung abwarten. Ein unbekannter Ausgang bleibt gesperrt; keine Rücksetzung der Reservierungen.

Aktuell fehlen Kostenfreigabe, konkreter Google-Zugang samt Kontoprüfung und geeignete freigegebene Fotodaten. Es wurden keine Kosten ausgelöst. Diese fehlenden Voraussetzungen können nicht durch Softwaretests ersetzt werden.
