...
Der Google-Zugang ist eingerichtet. Am 1. September 2026 wurde nach getrennten Einwilligungen genau ein freigegebener Fall F01 ausgeführt: Der serverseitige Datensatz meldet `succeeded`, 18.104 ms Laufzeit und 30 Cent Reservierung. Externe KI wurde danach wieder ausgeschaltet. Das optisch gelungene Ergebnis wurde wegen einer erfundenen Tür als nicht raumtreu verworfen und privat gelöscht. Der Google-Billing-Abgleich am 3. September 2026 weist 0,06 Euro Verbrauch aus; das Testguthaben deckt ihn vollständig, daher sind 0,00 Euro zahlbar. Die interne Buchhaltung hält für zwei abgeschlossene Versuche weiterhin vorsorglich 0,60 Euro reserviert und 0,06 Euro tatsächlich erfasst. Bild- und Zuordnungsdaten bleiben privat außerhalb von Git.
