...
- **Ergänzende Abnahme am 31. August 2026:** Die anschließend freigegebene isolierte GitHub-Prüfung bestand 65 Supabase-SQL-Prüfungen, acht echte Integrationsprüfungen einschließlich separater paralleler PostgreSQL-Verbindungen und ausgeführtem Löschjob sowie Build, Lint, 16 lokale SQL- und 54 Funktions-/Browserprüfungen. Ein dabei gefundener Fehler in der Herkunftsprüfung wurde durch eine explizite serverseitige Testadresse behoben. Der Entwicklungsbranch ist auf GitHub gespeichert; `main` und das verbundene Supabase-Projekt bleiben unverändert.
...
- **Status:** Am 7. September 2026 lokal vorbereitet und geprüft; die Datenbankmigration ist noch nicht auf das Supabase-Projekt angewendet. Vertex bleibt ausgeschaltet.
- **Ablauf:** Nach dem Planungsbriefing erscheint rechts ein separater Bereich für den kontrollierten KI-Bildtest. Er verlangt eine eigene Einwilligung und die Anzahl sichtbarer Türen, Fenster und Durchgänge. Ohne Einwilligung wird kein Gastfoto übertragen.
...
- **Aktivierung:** Vor einem realen Versuch müssen die Migration in das freigegebene Supabase-Projekt eingespielt, die serverseitige Gast-Testfreigabe bewusst gesetzt, die Testkampagne mit dem aktuellen Rechnungsabgleich erneut bewaffnet und der konkrete Vertex-Aufruf ausdrücklich bestätigt werden. Keine dieser Aktionen erfolgt durch diese Entscheidung.
