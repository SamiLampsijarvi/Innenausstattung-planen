...
**Teilstatus Phase 5A:** Supabase wurde im kostenlosen Tarif in Frankfurt für die abgeschirmte Entwicklung eingerichtet. Registrierung, E-Mail-Bestätigung, Anmeldung, private Projekte und private Raumfotos funktionieren. Fotoersetzung lädt neue Dateien zuerst hoch und behält vorhandene Fotos bei einem Fehlschlag; teilweise hochgeladene neue Dateien werden bestmöglich zurückgerollt. Die Passwort-Wiederherstellung ist in der Oberfläche ergänzt und automatisch auf Desktop und Mobil geprüft. Projektpapierkorb, 14-tägige Kontolöschung, automatische endgültige Löschung und die dazugehörigen Zugriffsregeln sind umgesetzt und im Entwicklungsprojekt geprüft. Benachrichtigungs-E-Mails sind technisch vorbereitet, aber noch nicht mit einem Anbieter verbunden oder veröffentlicht. Der kostenlose Supabase-Tarif erstellt keine automatischen Datenbanksicherungen; bei einem späteren Tarifwechsel oder eigenen Sicherungen muss die bestätigte 30-Tage-Bereinigung vorab abgesichert werden. Gastübernahme und vollständige Mehrnutzer-Zugriffstests bleiben offen.
