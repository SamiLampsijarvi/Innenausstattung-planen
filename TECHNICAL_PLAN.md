...
**Abschlussstand Phase 5:** Supabase wurde im kostenlosen Tarif in Frankfurt für die abgeschirmte Entwicklung eingerichtet. Registrierung, E-Mail-Bestätigung, Anmeldung, Passwort-Wiederherstellung, private Projekte und private Raumfotos sind verbunden. Neue Konten erhalten eine eindeutige achtstellige Kontonummer. Das beim Registrieren geöffnete Gastprojekt wird nach erfolgreicher Anmeldung idempotent übernommen und lokal erst nach bestätigter Speicherung entfernt. Private Foto-Uploads benötigen eine protokollierte Einwilligung; ein Widerruf sperrt neue Uploads und entfernt die gespeicherten Fotos. Projektpapierkorb, 14-tägige Kontolöschung, automatische endgültige Löschung und transaktionale Benachrichtigungs-E-Mails sind umgesetzt. Mehrnutzer-, Einwilligungs-, Zugriffs-, Lösch- und Browserregeln werden automatisch geprüft. Die technische Datenschutz- und Sicherheitsdokumentation liegt in `docs/PHASE_5_PRIVACY_READINESS.md`. Vor Testpersonen oder Veröffentlichung bleiben die dort genannten Verantwortlichenangaben, Vertragsnachweise und Rechtstexte juristisch zu prüfen. Der kostenlose Supabase-Tarif erstellt keine automatischen Datenbanksicherungen; bei einem späteren Tarifwechsel oder eigenen Sicherungen muss die bestätigte 30-Tage-Bereinigung vorab abgesichert werden.
